/*******************************************************************************************************************************
 * AK.RudyMQ.Tests.Integration.NonPersistedHappyPathTests
...
{
    /// <summary>
    /// Happy-path integration tests for non-persisted queues.
    /// </summary>
    /// <author>Aashish Koirala</author>
    [TestClass]
    public class NonPersistedHappyPathTests
    {
        ...
        public void EnsureRun()
        {
            lock (isRunLock)
            {
                ...
                runner = new EndToEndRunner(Config.Get("hostName", "localhost"),
                                            ...
                                            new[] { "NP_Queue1", "NP_Queue2", "NP_Queue3" },
                                            10, 500, 5, 100, false, false);
        ...
        public void Non_Persisted_Happy_Path_Has_No_Receive_Exceptions()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Non_Persisted_Happy_Path_Has_No_Send_Exceptions()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Non_Persisted_Happy_Path_Send_And_Receive_Counts_Match()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Non_Persisted_Happy_Path_All_Messages_Are_Accounted_For()
        {
