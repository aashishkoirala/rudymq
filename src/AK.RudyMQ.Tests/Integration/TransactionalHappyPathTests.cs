/*******************************************************************************************************************************
 * AK.RudyMQ.Tests.Integration.TransactionalHappyPathTests
...
{
    /// <summary>
    /// Happy-path integration tests for transactional queues.
    /// </summary>
    /// <author>Aashish Koirala</author>
    [TestClass]
    public class TransactionalHappyPathTests
    {
        ...
        public void EnsureRun()
        {
            lock (isRunLock)
            {
                ...
                runner = new EndToEndRunner(Config.Get("hostName", "localhost"),
                                            ...
                                            new[] { "T_Queue1", "T_Queue2", "T_Queue3" },
                                            10, 500, 5, 100, true, true);
        ...
        public void Transactional_Happy_Path_Has_No_Receive_Exceptions()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Transactional_Happy_Path_Has_No_Send_Exceptions()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Transactional_Happy_Path_Send_And_Receive_Counts_Match()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void Transactional_Happy_Path_All_Messages_Are_Accounted_For()
        {
